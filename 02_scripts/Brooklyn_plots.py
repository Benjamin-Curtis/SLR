...
# -*- coding: utf-8 -*-
"""
Created on Sat May  3 19:30:36 2025
...
df=pd.read_csv("school_district_summary_brooklyn.csv")
...
fig1.suptitle('Total Assessed Value by Business Ownership and Flood Risk in Brooklyn')
ax1.set_ylabel('Assessed Value')
fig1.tight_layout()
fig1.savefig('value_by_impact_brooklyn.png')
#%%
#Risk by School Code
...
by_school.plot.bar(title='Total Assessed Value at Risk by School Districts in Brooklyn', ax=ax2)
ax1.set_ylabel('Assessed Value')
fig1.tight_layout()
fig1.savefig('risk_value_by_brooklyn.png')
#%%
...
fig3.suptitle('Share of Total Assessed Property Value at Risk Brooklyn')
plt.pie(values, labels=labels,autopct='%1.1f%%')
fig3.tight_layout()
fig3.savefig("value_at_risk_brooklyn.png")
