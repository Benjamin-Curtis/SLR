...
# -*- coding: utf-8 -*-
"""
Created on Fri May  2 14:37:54 2025
...
#%%
#1. Load and Preprocess Parcels
#read in parcel data
parcels = pd.read_csv("B_Parcels.csv", dtype=str)

#Load in geo data of impacted parcels(trimmed layer)
impacted_parcels=gpd.read_file('Projected.gpkg',layer='trimmed')

#get unique impacted parcel IDs from SWIS_SBL_ID
impacted_swis=impacted_parcels['SWIS_SBL_ID'].unique()

#create binary indicator in full df for whether the parcel is impacted or not
...
#%%
# 5. export
direct_risk.to_csv('school_district_summary_brooklyn.csv')
direct_risk.to_excel('school_district_summary_brooklyn.xlsx')
